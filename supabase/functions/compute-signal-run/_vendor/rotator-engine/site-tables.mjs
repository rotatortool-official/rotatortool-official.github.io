...
export default {
  ...
  "TOKENOMICS_DB": {
    ...
    "sui": { "deflation": "none", "unlockRisk": "high", "unlock30d": 6.8 },
    "aptos": { "deflation": "none", "unlockRisk": "high", "unlock30d": 5.9 },
    "sei-network": { "deflation": "none", "unlockRisk": "high" },
    "render-token": { "deflation": "partial", "unlockRisk": "medium", "unlock30d": 3.2 },
