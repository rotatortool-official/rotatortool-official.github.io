  ...
  if (isPro) {
    ...
    body.innerHTML = '<div class="modal-title">⚡ Unlock Pro — Free</div>'
      ...
      + '<div style="text-align:center;margin-bottom:6px;">'
        + '<span style="font-size:10px;color:var(--muted);">Love Rotator? </span>'
        + '<a href="#" onclick="closeModal(\'pro-modal\');openModal(\'donate-modal\');return false;" style="font-size:10px;color:var(--bnb);">☕ Support the project</a>'
      + '</div>'
      + '<div class="pro-divider"></div>'
